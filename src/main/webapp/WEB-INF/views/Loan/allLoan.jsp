					...
					<div class="products_aj">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<c:forEach var="product" items="${loans}">
									<td><c:out value="${product.io_member.fullName}" /></td>
									<td><c:out value="${product.followerMemberName}" /></td>
									<td><c:out value="${product.loanvalue}" /></td>
									<td><c:out value="${product.loanDate}" /></td>


									<td><a
										href='<spring:url value="/admin/loan/edit/${product.id}" />'>
											<img
											src="<spring:url value="/resources/Css/images/icons/options.png"   />">
									</a> <a
										href='<spring:url value="/admin/loan/details/${product.id}" />'>
											<img
											src="<c:url value="/resources/Css/images/icons/view.png "></c:url>">
									</a> <a
										href='<spring:url value="/admin/loan/delete/${product.id}" />'><img
