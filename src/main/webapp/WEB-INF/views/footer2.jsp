...
<body class="animsition">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			<a href="#"> <img class="h-size2" src="images/icons/paypal.png"
				...
				src="<spring:url value="/resources/images/icons/mastercard.png" ></spring:url>"
				alt="IMG-MASTERCARD">
			</a> <a href="#"> <img class="h-size2"
				src="<spring:url value="/resources/images/icons/express.png" ></spring:url>"
				alt="IMG-EXPRESS">
			</a> <a href="#"> <img class="h-size2"
				src="<spring:url value="/resources/images/icons/discover.png" ></spring:url>"
				alt="IMG-DISCOVER">
			</a>

			<div class="t-center s-text8 p-t-20">
				Copyright Â© 2018 All rights reserved. | This template is made
	...
	<script type="text/javascript"
		src="http://code.jquery.com/ui/1.10.1/jquery-ui.min.js"></script>
